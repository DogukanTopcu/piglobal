...
import { plasticProductsAndProductionHeroData } from '@/app/en/data/heroData';
import Hero from '../../../../common/Hero';
import { packagingTypeData, plasticProducts, plasticProductsTableData } from '@/app/en/data/plasticProductsData';
...
const PlasticProductSlug = ({ params }: { params: { slug: string } }) => {
    ...
    const tableType = packagingTypeData.find((t) => t.url == params.slug);
    const table = plasticProductsTableData.filter((t) => t.tableType == tableType!.title);
...
const Table = ({ tableTitle } : { tableTitle : string }) => {
    const products = plasticProducts.filter((p) => p.table == tableTitle);
