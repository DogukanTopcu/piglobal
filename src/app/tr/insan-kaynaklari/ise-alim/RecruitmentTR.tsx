...
import { RecruitmentsHeroDataTR } from '../../data/heroDataTR';
...
const contentData = `<div class='container max-w-4xl mx-auto my-24 px-4'>
          <h1 class='sm:leading-10 sm:text-xl text-lg font-semibold'>Pi Global Co. İşe Alım Süreci</h1>
          <br />
          <br />
          <p class='sm:leading-8 leading-7 sm:text-lg'>Pi Global Co. olarak başarımızın en değerli kaynağımız olan çalışanlarımıza bağlı olduğuna yürekten inanıyoruz. Bu kapsamda, misyonumuz, vizyonumuz ve prensiplerimiz çerçevesinde en yetenekli çalışanları bulmak ve istihdam etmek amacıyla insan kaynakları süreçlerimizi geliştiriyoruz.</p>
          <br />
          <br />
          <p class='sm:leading-8 leading-7 sm:text-lg'>Açık pozisyonlarımıza başvuran adayları aşağıda belirtilen sürece göre değerlendiriyor ve işe alım sürecini tamamlamış oluyoruz.</p>
          <br />
          <br />
...
const RecruitmentTR = () => {
  ...
  const data = RecruitmentsHeroDataTR;
  return (
    <div>
